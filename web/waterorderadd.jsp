  ...
  crossorigin="anonymous"></script>
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                    <ul class="navbar-nav ml-auto ">
                        <li class="nav-item active">
                            <a class="nav-link" href="Vehicle/home/Vhome.jsp">Home <span class="sr-only">(current)</span></a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="../../Employee/Search Customer Details/index.jsp">Water Orders</a>
    ...
    <table class="table table-hover ">
        ...
        <tr style="background-color:<%=color%>;">
            ...
            <td><%=pList.get(1)%></td>
             <td><%=pList.get(2)%></td>
            <td><button type="button"name="btn" value="<%=pList.get(0)%>" class="btn btn-secondary">Remove</button></td>
